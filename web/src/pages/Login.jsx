      ...
      <div className="max-w-md w-full relative">
        <div className="bg-slate-900 shadow-2xl rounded-3xl p-10 border border-slate-800 backdrop-blur-sm">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400">GasFlow Delivery Admin & Manager Panel</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-4 bg-slate-800/50 border border-slate-700 rounded-2xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
